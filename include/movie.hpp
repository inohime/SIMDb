...
namespace Imdb {
    ...
    public:
        ...
        constexpr void displayCast(std::string_view selectedMovie, const Records &rc);
        constexpr void displayActorsTitles(std::string_view selectedActor, const Records &rc);
    };
} // namespace Imdb
